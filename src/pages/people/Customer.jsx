                            ...
                            {loading ? (
                                ...
                                paginatedRows.map((r) => (
                                    <TableRow key={r.reference}>
                                        ...
                                        <TableCell><div className="bg-green-600 w-18 items-center rounded-lg text-white flex text-center h-5.5"><Dot className="-mr-3 -ml-2  " size={40} /> {r.custStatus}</div></TableCell>
                                    </TableRow>
                                ))
                            )}
                        </TableBody>
