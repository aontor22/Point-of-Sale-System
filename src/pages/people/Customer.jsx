...
export default function SaleReports() {
    ...
    const filtered = orders.filter((r) => {
        ...
        const matchSearch = r.customer.toLowerCase().includes(s);
        const matchCat = category === "all" || r.category === category;
        const matchBrand = brand === "all" || r.brand === brand;
        const matchStatus = status === "all" || r.custStatus === status;
                                    ...
                                    <TableRow key={r.id}>
                                        <TableCell>
                                            <Checkbox
                                                ...
                                                onCheckedChange={(checked) => handleToggleRow(r.id, checked)}
                                            />
                                        </TableCell>
                                        ...
                                        <TableCell>
                                            <div className="bg-green-600 w-18 items-center rounded-lg text-white flex text-center h-5.5">
                                                <Dot className="-mr-3 -ml-2" size={40} /> {r.custStatus}
                                            </div>
                                        </TableCell>
                                    </TableRow>
                                ))
