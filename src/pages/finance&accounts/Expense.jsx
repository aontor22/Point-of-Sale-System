...
export default function SaleReports() {
    ...
    const currentPageIds = paginatedRows.map((r) => r.exID);
                            ...
                            {loading ? (
                                ...
                                paginatedRows.map((r) => (
                                    <TableRow key={r.exID}>
                                        <TableCell>
                                            <Checkbox
                                                aria-label={`Select ${r.exID || r.exStatus}`}
                                                checked={selectedIds.includes(r.exID)}
                                                onCheckedChange={(checked) => handleToggleRow(r.exID, checked)}
                                            />
                                        </TableCell>
