    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex-1">
                <h1 className="text-xl font-semibold text-slate-800 dark:text-slate-300">Subscriptions Management</h1>
                <span className="text-slate-500">Monitor and control all subscription plans </span>
            </div>
